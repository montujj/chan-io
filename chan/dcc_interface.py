...
class ChanDCCInterface(ABC):
    """Abstract base class defining the interface for DCC-specific backends to implement .chan file export/import and scene queries."""
    ...
    def import_chan(self, path: str, node: str) -> int:
        """Import a .chan file and apply animation to the given node in the DCC."""
        pass
